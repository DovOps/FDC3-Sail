...
export const TRADINGVIEW_QUALIFIED_TICKER_BY_TRADERX_SYMBOL: {
...
export const qualifyTradingViewSymbol = (
  rawTicker: string | undefined | null,
): string | undefined => {
  ...
  return (
    TRADINGVIEW_QUALIFIED_TICKER_BY_TRADERX_SYMBOL[normalized] ??
    `NASDAQ:${normalized}`
  )
}
...
export const resolveTradingViewSymbolFromContext = (
  context: any,
): string | undefined => {
